...
main()
{
	char nombre[100],apellidoP[100],apellidoM[100],puesto[100],nombreproducto[100];
	...
	switch(opc)
	{
		...
		case (2):
			...
			{ 
				...
				if(re==1)
				{
					...
					{
						printf("Borrado exitoso del archivo " );
					}
					getch();
					goto et5;
				}else if(re==0)
		...
		case (3):
			...
			{
				//crear un nuevo fichero con nueva informacion y que borre 
				//la informacion y cree otro archivo
			}else if(res==3)
			{				
				system("cls");
				goto et2;			
